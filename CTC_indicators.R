...
wayfinderdev <-odbcConnect("Wayfinderdev", uid=Sys.getenv("sqlUser"), pwd=Sys.getenv("sqlDevPass"))

# completions don't have InRMR flag, so joining on meta.schools
compl <- sqlQuery(wayfinderdev, "
                  SELECT a.*
...
YEARS<-3    # years can be changed in case we want to look at different outcome timeframes
...
QD$LatestEnd<-as.Date(QD$LatestEnd)
...
FlatCohort <- cohort %>%
  select(
    ...
    ThreeYrAwardAny,
    ThreeYrAwardTransfer,
    ThreeYrAwardOrTransfer,
    ThreeYrAwardNoTransfer,
    ThreeYrTransfer,
    ThreeYrTransferNoAward,
    ThreeYrAssociates,
    ThreeYrAssociatesTransfer,
    ThreeYrAssociatesNoTransfer,
    ThreeYrWorkforce,
    ThreeYrWorkforceTransfer,
    ThreeYrWorkforceNoTransfer,
    ThreeYrLongCert,
    ThreeYrLongCertTransfer,
    ThreeYrLongCertNoTransfer,
    ThreeYrShortCert,
    ThreeYrShortCertTransfer,
    ThreeYrShortCertNoTransfer,
    ThreeYrNoAwardNoTransfer,
    ThreeYrStillEnrolled,
    ThreeYrStillEnrolled45Creds,
    ThreeYrStillEnrolledLess45Creds,
    ThreeYrLeft,
    ThreeYrLeft45Creds,
    ThreeYrLeftLess45Creds,
